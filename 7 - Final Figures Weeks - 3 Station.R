simcoe <- read.csv('simcoe_final_weeks_3.csv', header = T)
simcoe_div <- read.csv('simcoe_final_3_weeks_diversity', header = T)
simcoe_corr <- read.csv('simcoe_final_corr_weeks_3.csv', header = T)
simcoe_pairst <- read.csv('simcoe_final_pair_stab_weeks_3.csv', header = T)
