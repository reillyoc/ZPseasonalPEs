...
#subset dataframes by station to add a station tag to species id
simcoe_c6_2014 <- subset(simcoe_2014_m, Station_ID == 'C6')
simcoe_c6_2014$Species <- paste("C6", simcoe_c6_2014$Species, sep=" ")
...
simcoe_s15_2014 <- subset(simcoe_2014_m, Station_ID == 'S15')
simcoe_s15_2014$Species <- paste("S15", simcoe_s15_2014$Species, sep=" ")

#recombine dataframes
simcoe_spec_2014 <- rbind(simcoe_c6_2014, simcoe_c9_2014)
simcoe_spec_2014 <- rbind(simcoe_spec_2014, simcoe_k42_2014)
simcoe_spec_2014 <- rbind(simcoe_spec_2014, simcoe_k45_2014)
simcoe_spec_2014 <- rbind(simcoe_spec_2014, simcoe_s15_2014)
...
simcoe_c6_2014_w_cv_ts <- subset(simcoe_2014_cv, Station_ID == 'C6')
simcoe_c6_2014_w_cv_ts$Species <- paste("C6", simcoe_c6_2014_w_cv_ts$Species, sep=" ")
simcoe_c6_2014_w_cv_ts$Species_ID <- 1:nrow(simcoe_c6_2014_w_cv_ts)
...
simcoe_s15_2014_w_cv_ts <- subset(simcoe_2014_cv, Station_ID == 'S15')
simcoe_s15_2014_w_cv_ts$Species <- paste("S15", simcoe_s15_2014_w_cv_ts$Species, sep=" ")
simcoe_s15_2014_w_cv_ts$Species_ID <- 1:nrow(simcoe_s15_2014_w_cv_ts) 


simcoe_spec_2014_w_sp_ts <- rbind(simcoe_c6_2014_w_cv_ts, simcoe_c9_2014_w_cv_ts)
simcoe_spec_2014_w_sp_ts <- rbind(simcoe_spec_2014_w_sp_ts, simcoe_k42_2014_w_cv_ts)
simcoe_spec_2014_w_sp_ts <- rbind(simcoe_spec_2014_w_sp_ts, simcoe_k45_2014_w_cv_ts)
simcoe_spec_2014_w_sp_ts <- rbind(simcoe_spec_2014_w_sp_ts, simcoe_s15_2014_w_cv_ts)
...
#Step 1 
simcoe_2014_ind_W_ts_c6 <- filter(simcoe_2014_ind_W_ts, station_1 == "C6" & station_2 == "C6")
...
simcoe_2014_ind_W_ts_s15 <- filter(simcoe_2014_ind_W_ts, station_1 == "S15" & station_2 == "S15")


#Step 2 - Calculate Stabilization for each Station
#C6
simcoe_species_pairs_count_2014_c6 <- na.omit(simcoe_2014_ind_W_ts_c6)

simcoe_species_pairs_count_2014_c6$number_species_pairs <- nrow(simcoe_species_pairs_count_2014_c6)

simcoe_mean_W_sp_pairs_2014_c6 <- simcoe_species_pairs_count_2014_c6 %>% group_by(Year) %>%
  summarize(Station_ID = "C6",
            mean_lc_stab = mean(ind_W_2014, na.rm = T),
            total_species_pairs = mean(number_species_pairs))

simcoe_2014_W_ts_c6 <- simcoe_2014_ind_W_ts_c6 %>% group_by(Year) %>%
  summarize(W_2014 = sum(ind_W_2014, na.rm = TRUE))
...
#S15
simcoe_species_pairs_count_2014_s15 <- na.omit(simcoe_2014_ind_W_ts_s15)

simcoe_species_pairs_count_2014_s15$number_species_pairs <- nrow(simcoe_species_pairs_count_2014_s15)

simcoe_mean_W_sp_pairs_2014_s15 <- simcoe_species_pairs_count_2014_s15 %>% group_by(Year) %>%
  summarize(Station_ID = "S15",
            mean_lc_stab= mean(ind_W_2014, na.rm = T),
            total_species_pairs = mean(number_species_pairs))

simcoe_2014_W_ts_s15 <- simcoe_2014_ind_W_ts_s15 %>% group_by(Year) %>%
  summarize(W_2014 = sum(ind_W_2014, na.rm = TRUE))

#Step 4
simcoe_2014_ind_W_as1 <- rbind(simcoe_2014_W_ts_c6, simcoe_2014_W_ts_c9)
simcoe_2014_ind_W_as1 <- rbind(simcoe_2014_ind_W_as1, simcoe_2014_W_ts_k42)
simcoe_2014_ind_W_as1 <- rbind(simcoe_2014_ind_W_as1, simcoe_2014_W_ts_k45)
simcoe_2014_ind_W_as1 <- rbind(simcoe_2014_ind_W_as1, simcoe_2014_W_ts_s15)

simcoe_2014_W_as1 <- simcoe_2014_ind_W_as1 %>% group_by(Year) %>%
  summarize(as2_2014 = sum(W_2014, na.rm = TRUE))

simcoe_mean_lc_sp_pairs_2014 <- rbind(simcoe_mean_W_sp_pairs_2014_c6, simcoe_mean_W_sp_pairs_2014_c9)
simcoe_mean_lc_sp_pairs_2014 <- rbind(simcoe_mean_lc_sp_pairs_2014, simcoe_mean_W_sp_pairs_2014_k42)
simcoe_mean_lc_sp_pairs_2014 <- rbind(simcoe_mean_lc_sp_pairs_2014, simcoe_mean_W_sp_pairs_2014_k45)
simcoe_mean_lc_sp_pairs_2014 <- rbind(simcoe_mean_lc_sp_pairs_2014, simcoe_mean_W_sp_pairs_2014_s15)
...
simcoe_mean_corr_2014_c6 <- simcoe_species_pairs_count_2014_c6 %>% ungroup() %>% select(corr, ind_pop_pair_cv_2014, ind_W_2014)
...
simcoe_mean_corr_2014_s15 <- simcoe_species_pairs_count_2014_s15 %>% ungroup() %>% select(corr, ind_pop_pair_cv_2014, ind_W_2014)
simcoe_mean_corr_2014_lc <- rbind(simcoe_mean_corr_2014_c6, simcoe_mean_corr_2014_c9)
simcoe_mean_corr_2014_lc <- rbind(simcoe_mean_corr_2014_lc, simcoe_mean_corr_2014_k42)
simcoe_mean_corr_2014_lc <- rbind(simcoe_mean_corr_2014_lc, simcoe_mean_corr_2014_k45)
simcoe_mean_corr_2014_lc <- rbind(simcoe_mean_corr_2014_lc, simcoe_mean_corr_2014_s15)
...
#subset dataframes by station to add a station tag to species id
simcoe_c6_2015 <- subset(simcoe_2015_m, Station_ID == 'C6')
simcoe_c6_2015$Species <- paste("C6", simcoe_c6_2015$Species, sep=" ")
...
simcoe_s15_2015 <- subset(simcoe_2015_m, Station_ID == 'S15')
simcoe_s15_2015$Species <- paste("S15", simcoe_s15_2015$Species, sep=" ")

#recombine dataframes
simcoe_spec_2015 <- rbind(simcoe_c6_2015, simcoe_c9_2015)
simcoe_spec_2015 <- rbind(simcoe_spec_2015, simcoe_k42_2015)
simcoe_spec_2015 <- rbind(simcoe_spec_2015, simcoe_k45_2015)
simcoe_spec_2015 <- rbind(simcoe_spec_2015, simcoe_s15_2015)
...
simcoe_c6_2015_w_cv_ts <- subset(simcoe_2015_cv, Station_ID == 'C6')
simcoe_c6_2015_w_cv_ts$Species <- paste("C6", simcoe_c6_2015_w_cv_ts$Species, sep=" ")
simcoe_c6_2015_w_cv_ts$Species_ID <- 1:nrow(simcoe_c6_2015_w_cv_ts)
...
simcoe_s15_2015_w_cv_ts <- subset(simcoe_2015_cv, Station_ID == 'S15')
simcoe_s15_2015_w_cv_ts$Species <- paste("S15", simcoe_s15_2015_w_cv_ts$Species, sep=" ")
simcoe_s15_2015_w_cv_ts$Species_ID <- 1:nrow(simcoe_s15_2015_w_cv_ts) 


simcoe_spec_2015_w_sp_ts <- rbind(simcoe_c6_2015_w_cv_ts, simcoe_c9_2015_w_cv_ts)
simcoe_spec_2015_w_sp_ts <- rbind(simcoe_spec_2015_w_sp_ts, simcoe_k42_2015_w_cv_ts)
simcoe_spec_2015_w_sp_ts <- rbind(simcoe_spec_2015_w_sp_ts, simcoe_k45_2015_w_cv_ts)
simcoe_spec_2015_w_sp_ts <- rbind(simcoe_spec_2015_w_sp_ts, simcoe_s15_2015_w_cv_ts)
...
#Step 1 
simcoe_2015_ind_W_ts_c6 <- filter(simcoe_2015_ind_W_ts, station_1 == "C6" & station_2 == "C6")
...
simcoe_2015_ind_W_ts_s15 <- filter(simcoe_2015_ind_W_ts, station_1 == "S15" & station_2 == "S15")


#Step 2 - Calculate Stabilization for each Station
#C6
simcoe_species_pairs_count_2015_c6 <- na.omit(simcoe_2015_ind_W_ts_c6)

simcoe_species_pairs_count_2015_c6$number_species_pairs <- nrow(simcoe_species_pairs_count_2015_c6)

simcoe_mean_W_sp_pairs_2015_c6 <- simcoe_species_pairs_count_2015_c6 %>% group_by(Year) %>%
  summarize(Station_ID = "C6",
            mean_lc_stab = mean(ind_W_2015, na.rm = T),
            total_species_pairs = mean(number_species_pairs))

simcoe_2015_W_ts_c6 <- simcoe_2015_ind_W_ts_c6 %>% group_by(Year) %>%
  summarize(W_2015 = sum(ind_W_2015, na.rm = TRUE))
...
#S15
simcoe_species_pairs_count_2015_s15 <- na.omit(simcoe_2015_ind_W_ts_s15)

simcoe_species_pairs_count_2015_s15$number_species_pairs <- nrow(simcoe_species_pairs_count_2015_s15)

simcoe_mean_W_sp_pairs_2015_s15 <- simcoe_species_pairs_count_2015_s15 %>% group_by(Year) %>%
  summarize(Station_ID = "S15",
            mean_lc_stab= mean(ind_W_2015, na.rm = T),
            total_species_pairs = mean(number_species_pairs))

simcoe_2015_W_ts_s15 <- simcoe_2015_ind_W_ts_s15 %>% group_by(Year) %>%
  summarize(W_2015 = sum(ind_W_2015, na.rm = TRUE))

#Step 4
simcoe_2015_ind_W_as1 <- rbind(simcoe_2015_W_ts_c6, simcoe_2015_W_ts_c9)
simcoe_2015_ind_W_as1 <- rbind(simcoe_2015_ind_W_as1, simcoe_2015_W_ts_k42)
simcoe_2015_ind_W_as1 <- rbind(simcoe_2015_ind_W_as1, simcoe_2015_W_ts_k45)
simcoe_2015_ind_W_as1 <- rbind(simcoe_2015_ind_W_as1, simcoe_2015_W_ts_s15)

simcoe_2015_W_as1 <- simcoe_2015_ind_W_as1 %>% group_by(Year) %>%
  summarize(as2_2015 = sum(W_2015, na.rm = TRUE))

simcoe_mean_lc_sp_pairs_2015 <- rbind(simcoe_mean_W_sp_pairs_2015_c6, simcoe_mean_W_sp_pairs_2015_c9)
simcoe_mean_lc_sp_pairs_2015 <- rbind(simcoe_mean_lc_sp_pairs_2015, simcoe_mean_W_sp_pairs_2015_k42)
simcoe_mean_lc_sp_pairs_2015 <- rbind(simcoe_mean_lc_sp_pairs_2015, simcoe_mean_W_sp_pairs_2015_k45)
simcoe_mean_lc_sp_pairs_2015 <- rbind(simcoe_mean_lc_sp_pairs_2015, simcoe_mean_W_sp_pairs_2015_s15)
...
simcoe_mean_corr_2015_c6 <- simcoe_species_pairs_count_2015_c6 %>% ungroup() %>% select(corr, ind_pop_pair_cv_2015, ind_W_2015)
...
simcoe_mean_corr_2015_s15 <- simcoe_species_pairs_count_2015_s15 %>% ungroup() %>% select(corr, ind_pop_pair_cv_2015, ind_W_2015)
simcoe_mean_corr_2015_lc <- rbind(simcoe_mean_corr_2015_c6, simcoe_mean_corr_2015_c9)
simcoe_mean_corr_2015_lc <- rbind(simcoe_mean_corr_2015_lc, simcoe_mean_corr_2015_k42)
simcoe_mean_corr_2015_lc <- rbind(simcoe_mean_corr_2015_lc, simcoe_mean_corr_2015_k45)
simcoe_mean_corr_2015_lc <- rbind(simcoe_mean_corr_2015_lc, simcoe_mean_corr_2015_s15)
...
#subset dataframes by station to add a station tag to species id
simcoe_c6_2016 <- subset(simcoe_2016_m, Station_ID == 'C6')
simcoe_c6_2016$Species <- paste("C6", simcoe_c6_2016$Species, sep=" ")
...
simcoe_s15_2016 <- subset(simcoe_2016_m, Station_ID == 'S15')
simcoe_s15_2016$Species <- paste("S15", simcoe_s15_2016$Species, sep=" ")

#recombine dataframes
simcoe_spec_2016 <- rbind(simcoe_c6_2016, simcoe_c9_2016)
simcoe_spec_2016 <- rbind(simcoe_spec_2016, simcoe_k42_2016)
simcoe_spec_2016 <- rbind(simcoe_spec_2016, simcoe_k45_2016)
simcoe_spec_2016 <- rbind(simcoe_spec_2016, simcoe_s15_2016)
...
simcoe_c6_2016_w_cv_ts <- subset(simcoe_2016_cv, Station_ID == 'C6')
simcoe_c6_2016_w_cv_ts$Species <- paste("C6", simcoe_c6_2016_w_cv_ts$Species, sep=" ")
simcoe_c6_2016_w_cv_ts$Species_ID <- 1:nrow(simcoe_c6_2016_w_cv_ts)
...
simcoe_s15_2016_w_cv_ts <- subset(simcoe_2016_cv, Station_ID == 'S15')
simcoe_s15_2016_w_cv_ts$Species <- paste("S15", simcoe_s15_2016_w_cv_ts$Species, sep=" ")
simcoe_s15_2016_w_cv_ts$Species_ID <- 1:nrow(simcoe_s15_2016_w_cv_ts) 


simcoe_spec_2016_w_sp_ts <- rbind(simcoe_c6_2016_w_cv_ts, simcoe_c9_2016_w_cv_ts)
simcoe_spec_2016_w_sp_ts <- rbind(simcoe_spec_2016_w_sp_ts, simcoe_k42_2016_w_cv_ts)
simcoe_spec_2016_w_sp_ts <- rbind(simcoe_spec_2016_w_sp_ts, simcoe_k45_2016_w_cv_ts)
simcoe_spec_2016_w_sp_ts <- rbind(simcoe_spec_2016_w_sp_ts, simcoe_s15_2016_w_cv_ts)
...
#Step 1 
simcoe_2016_ind_W_ts_c6 <- filter(simcoe_2016_ind_W_ts, station_1 == "C6" & station_2 == "C6")
...
simcoe_2016_ind_W_ts_s15 <- filter(simcoe_2016_ind_W_ts, station_1 == "S15" & station_2 == "S15")


#Step 2 - Calculate Stabilization for each Station
#C6
simcoe_species_pairs_count_2016_c6 <- na.omit(simcoe_2016_ind_W_ts_c6)

simcoe_species_pairs_count_2016_c6$number_species_pairs <- nrow(simcoe_species_pairs_count_2016_c6)

simcoe_mean_W_sp_pairs_2016_c6 <- simcoe_species_pairs_count_2016_c6 %>% group_by(Year) %>%
  summarize(Station_ID = "C6",
            mean_lc_stab = mean(ind_W_2016, na.rm = T),
            total_species_pairs = mean(number_species_pairs))

simcoe_2016_W_ts_c6 <- simcoe_2016_ind_W_ts_c6 %>% group_by(Year) %>%
  summarize(W_2016 = sum(ind_W_2016, na.rm = TRUE))
...
#S15
simcoe_species_pairs_count_2016_s15 <- na.omit(simcoe_2016_ind_W_ts_s15)

simcoe_species_pairs_count_2016_s15$number_species_pairs <- nrow(simcoe_species_pairs_count_2016_s15)

simcoe_mean_W_sp_pairs_2016_s15 <- simcoe_species_pairs_count_2016_s15 %>% group_by(Year) %>%
  summarize(Station_ID = "S15",
            mean_lc_stab= mean(ind_W_2016, na.rm = T),
            total_species_pairs = mean(number_species_pairs))

simcoe_2016_W_ts_s15 <- simcoe_2016_ind_W_ts_s15 %>% group_by(Year) %>%
  summarize(W_2016 = sum(ind_W_2016, na.rm = TRUE))

#Step 4
simcoe_2016_ind_W_as1 <- rbind(simcoe_2016_W_ts_c6, simcoe_2016_W_ts_c9)
simcoe_2016_ind_W_as1 <- rbind(simcoe_2016_ind_W_as1, simcoe_2016_W_ts_k42)
simcoe_2016_ind_W_as1 <- rbind(simcoe_2016_ind_W_as1, simcoe_2016_W_ts_k45)
simcoe_2016_ind_W_as1 <- rbind(simcoe_2016_ind_W_as1, simcoe_2016_W_ts_s15)

simcoe_2016_W_as1 <- simcoe_2016_ind_W_as1 %>% group_by(Year) %>%
  summarize(as2_2016 = sum(W_2016, na.rm = TRUE))

simcoe_mean_lc_sp_pairs_2016 <- rbind(simcoe_mean_W_sp_pairs_2016_c6, simcoe_mean_W_sp_pairs_2016_c9)
simcoe_mean_lc_sp_pairs_2016 <- rbind(simcoe_mean_lc_sp_pairs_2016, simcoe_mean_W_sp_pairs_2016_k42)
simcoe_mean_lc_sp_pairs_2016 <- rbind(simcoe_mean_lc_sp_pairs_2016, simcoe_mean_W_sp_pairs_2016_k45)
simcoe_mean_lc_sp_pairs_2016 <- rbind(simcoe_mean_lc_sp_pairs_2016, simcoe_mean_W_sp_pairs_2016_s15)
...
simcoe_mean_corr_2016_c6 <- simcoe_species_pairs_count_2016_c6 %>% ungroup() %>% select(corr, ind_pop_pair_cv_2016, ind_W_2016)
...
simcoe_mean_corr_2016_s15 <- simcoe_species_pairs_count_2016_s15 %>% ungroup() %>% select(corr, ind_pop_pair_cv_2016, ind_W_2016)
simcoe_mean_corr_2016_lc <- rbind(simcoe_mean_corr_2016_c6, simcoe_mean_corr_2016_c9)
simcoe_mean_corr_2016_lc <- rbind(simcoe_mean_corr_2016_lc, simcoe_mean_corr_2016_k42)
simcoe_mean_corr_2016_lc <- rbind(simcoe_mean_corr_2016_lc, simcoe_mean_corr_2016_k45)
simcoe_mean_corr_2016_lc <- rbind(simcoe_mean_corr_2016_lc, simcoe_mean_corr_2016_s15)
...
#subset dataframes by station to add a station tag to species id
simcoe_c6_2017 <- subset(simcoe_2017_m, Station_ID == 'C6')
simcoe_c6_2017$Species <- paste("C6", simcoe_c6_2017$Species, sep=" ")
...
simcoe_s15_2017 <- subset(simcoe_2017_m, Station_ID == 'S15')
simcoe_s15_2017$Species <- paste("S15", simcoe_s15_2017$Species, sep=" ")

#recombine dataframes
simcoe_spec_2017 <- rbind(simcoe_c6_2017, simcoe_c9_2017)
simcoe_spec_2017 <- rbind(simcoe_spec_2017, simcoe_k42_2017)
simcoe_spec_2017 <- rbind(simcoe_spec_2017, simcoe_k45_2017)
simcoe_spec_2017 <- rbind(simcoe_spec_2017, simcoe_s15_2017)
...
simcoe_c6_2017_w_cv_ts <- subset(simcoe_2017_cv, Station_ID == 'C6')
simcoe_c6_2017_w_cv_ts$Species <- paste("C6", simcoe_c6_2017_w_cv_ts$Species, sep=" ")
simcoe_c6_2017_w_cv_ts$Species_ID <- 1:nrow(simcoe_c6_2017_w_cv_ts)
...
simcoe_s15_2017_w_cv_ts <- subset(simcoe_2017_cv, Station_ID == 'S15')
simcoe_s15_2017_w_cv_ts$Species <- paste("S15", simcoe_s15_2017_w_cv_ts$Species, sep=" ")
simcoe_s15_2017_w_cv_ts$Species_ID <- 1:nrow(simcoe_s15_2017_w_cv_ts) 


simcoe_spec_2017_w_sp_ts <- rbind(simcoe_c6_2017_w_cv_ts, simcoe_c9_2017_w_cv_ts)
simcoe_spec_2017_w_sp_ts <- rbind(simcoe_spec_2017_w_sp_ts, simcoe_k42_2017_w_cv_ts)
simcoe_spec_2017_w_sp_ts <- rbind(simcoe_spec_2017_w_sp_ts, simcoe_k45_2017_w_cv_ts)
simcoe_spec_2017_w_sp_ts <- rbind(simcoe_spec_2017_w_sp_ts, simcoe_s15_2017_w_cv_ts)
...
#Step 1 
simcoe_2017_ind_W_ts_c6 <- filter(simcoe_2017_ind_W_ts, station_1 == "C6" & station_2 == "C6")
...
simcoe_2017_ind_W_ts_s15 <- filter(simcoe_2017_ind_W_ts, station_1 == "S15" & station_2 == "S15")


#Step 2 - Calculate Stabilization for each Station
#C6
simcoe_species_pairs_count_2017_c6 <- na.omit(simcoe_2017_ind_W_ts_c6)

simcoe_species_pairs_count_2017_c6$number_species_pairs <- nrow(simcoe_species_pairs_count_2017_c6)

simcoe_mean_W_sp_pairs_2017_c6 <- simcoe_species_pairs_count_2017_c6 %>% group_by(Year) %>%
  summarize(Station_ID = "C6",
            mean_lc_stab = mean(ind_W_2017, na.rm = T),
            total_species_pairs = mean(number_species_pairs))

simcoe_2017_W_ts_c6 <- simcoe_2017_ind_W_ts_c6 %>% group_by(Year) %>%
  summarize(W_2017 = sum(ind_W_2017, na.rm = TRUE))
...
#S15
simcoe_species_pairs_count_2017_s15 <- na.omit(simcoe_2017_ind_W_ts_s15)

simcoe_species_pairs_count_2017_s15$number_species_pairs <- nrow(simcoe_species_pairs_count_2017_s15)

simcoe_mean_W_sp_pairs_2017_s15 <- simcoe_species_pairs_count_2017_s15 %>% group_by(Year) %>%
  summarize(Station_ID = "S15",
            mean_lc_stab= mean(ind_W_2017, na.rm = T),
            total_species_pairs = mean(number_species_pairs))

simcoe_2017_W_ts_s15 <- simcoe_2017_ind_W_ts_s15 %>% group_by(Year) %>%
  summarize(W_2017 = sum(ind_W_2017, na.rm = TRUE))

#Step 4
simcoe_2017_ind_W_as1 <- rbind(simcoe_2017_W_ts_c6, simcoe_2017_W_ts_c9)
simcoe_2017_ind_W_as1 <- rbind(simcoe_2017_ind_W_as1, simcoe_2017_W_ts_k42)
simcoe_2017_ind_W_as1 <- rbind(simcoe_2017_ind_W_as1, simcoe_2017_W_ts_k45)
simcoe_2017_ind_W_as1 <- rbind(simcoe_2017_ind_W_as1, simcoe_2017_W_ts_s15)

simcoe_2017_W_as1 <- simcoe_2017_ind_W_as1 %>% group_by(Year) %>%
  summarize(as2_2017 = sum(W_2017, na.rm = TRUE))

simcoe_mean_lc_sp_pairs_2017 <- rbind(simcoe_mean_W_sp_pairs_2017_c6, simcoe_mean_W_sp_pairs_2017_c9)
simcoe_mean_lc_sp_pairs_2017 <- rbind(simcoe_mean_lc_sp_pairs_2017, simcoe_mean_W_sp_pairs_2017_k42)
simcoe_mean_lc_sp_pairs_2017 <- rbind(simcoe_mean_lc_sp_pairs_2017, simcoe_mean_W_sp_pairs_2017_k45)
simcoe_mean_lc_sp_pairs_2017 <- rbind(simcoe_mean_lc_sp_pairs_2017, simcoe_mean_W_sp_pairs_2017_s15)
...
simcoe_mean_corr_2017_c6 <- simcoe_species_pairs_count_2017_c6 %>% ungroup() %>% select(corr, ind_pop_pair_cv_2017, ind_W_2017)
...
simcoe_mean_corr_2017_s15 <- simcoe_species_pairs_count_2017_s15 %>% ungroup() %>% select(corr, ind_pop_pair_cv_2017, ind_W_2017)
simcoe_mean_corr_2017_lc <- rbind(simcoe_mean_corr_2017_c6, simcoe_mean_corr_2017_c9)
simcoe_mean_corr_2017_lc <- rbind(simcoe_mean_corr_2017_lc, simcoe_mean_corr_2017_k42)
simcoe_mean_corr_2017_lc <- rbind(simcoe_mean_corr_2017_lc, simcoe_mean_corr_2017_k45)
simcoe_mean_corr_2017_lc <- rbind(simcoe_mean_corr_2017_lc, simcoe_mean_corr_2017_s15)
...
#subset dataframes by station to add a station tag to species id
simcoe_c6_2018 <- subset(simcoe_2018_m, Station_ID == 'C6')
simcoe_c6_2018$Species <- paste("C6", simcoe_c6_2018$Species, sep=" ")
...
simcoe_s15_2018 <- subset(simcoe_2018_m, Station_ID == 'S15')
simcoe_s15_2018$Species <- paste("S15", simcoe_s15_2018$Species, sep=" ")

#recombine dataframes
simcoe_spec_2018 <- rbind(simcoe_c6_2018, simcoe_c9_2018)
simcoe_spec_2018 <- rbind(simcoe_spec_2018, simcoe_k42_2018)
simcoe_spec_2018 <- rbind(simcoe_spec_2018, simcoe_k45_2018)
simcoe_spec_2018 <- rbind(simcoe_spec_2018, simcoe_s15_2018)
...
simcoe_c6_2018_w_cv_ts <- subset(simcoe_2018_cv, Station_ID == 'C6')
simcoe_c6_2018_w_cv_ts$Species <- paste("C6", simcoe_c6_2018_w_cv_ts$Species, sep=" ")
simcoe_c6_2018_w_cv_ts$Species_ID <- 1:nrow(simcoe_c6_2018_w_cv_ts)
...
simcoe_s15_2018_w_cv_ts <- subset(simcoe_2018_cv, Station_ID == 'S15')
simcoe_s15_2018_w_cv_ts$Species <- paste("S15", simcoe_s15_2018_w_cv_ts$Species, sep=" ")
simcoe_s15_2018_w_cv_ts$Species_ID <- 1:nrow(simcoe_s15_2018_w_cv_ts) 


simcoe_spec_2018_w_sp_ts <- rbind(simcoe_c6_2018_w_cv_ts, simcoe_c9_2018_w_cv_ts)
simcoe_spec_2018_w_sp_ts <- rbind(simcoe_spec_2018_w_sp_ts, simcoe_k42_2018_w_cv_ts)
simcoe_spec_2018_w_sp_ts <- rbind(simcoe_spec_2018_w_sp_ts, simcoe_k45_2018_w_cv_ts)
simcoe_spec_2018_w_sp_ts <- rbind(simcoe_spec_2018_w_sp_ts, simcoe_s15_2018_w_cv_ts)
...
#Step 1 
simcoe_2018_ind_W_ts_c6 <- filter(simcoe_2018_ind_W_ts, station_1 == "C6" & station_2 == "C6")
...
simcoe_2018_ind_W_ts_s15 <- filter(simcoe_2018_ind_W_ts, station_1 == "S15" & station_2 == "S15")


#Step 2 - Calculate Stabilization for each Station
#C6
simcoe_species_pairs_count_2018_c6 <- na.omit(simcoe_2018_ind_W_ts_c6)

simcoe_species_pairs_count_2018_c6$number_species_pairs <- nrow(simcoe_species_pairs_count_2018_c6)

simcoe_mean_W_sp_pairs_2018_c6 <- simcoe_species_pairs_count_2018_c6 %>% group_by(Year) %>%
  summarize(Station_ID = "C6",
            mean_lc_stab = mean(ind_W_2018, na.rm = T),
            total_species_pairs = mean(number_species_pairs))

simcoe_2018_W_ts_c6 <- simcoe_2018_ind_W_ts_c6 %>% group_by(Year) %>%
  summarize(W_2018 = sum(ind_W_2018, na.rm = TRUE))
...
#S15
simcoe_species_pairs_count_2018_s15 <- na.omit(simcoe_2018_ind_W_ts_s15)

simcoe_species_pairs_count_2018_s15$number_species_pairs <- nrow(simcoe_species_pairs_count_2018_s15)

simcoe_mean_W_sp_pairs_2018_s15 <- simcoe_species_pairs_count_2018_s15 %>% group_by(Year) %>%
  summarize(Station_ID = "S15",
            mean_lc_stab= mean(ind_W_2018, na.rm = T),
            total_species_pairs = mean(number_species_pairs))

simcoe_2018_W_ts_s15 <- simcoe_2018_ind_W_ts_s15 %>% group_by(Year) %>%
  summarize(W_2018 = sum(ind_W_2018, na.rm = TRUE))

#Step 4
simcoe_2018_ind_W_as1 <- rbind(simcoe_2018_W_ts_c6, simcoe_2018_W_ts_c9)
simcoe_2018_ind_W_as1 <- rbind(simcoe_2018_ind_W_as1, simcoe_2018_W_ts_k42)
simcoe_2018_ind_W_as1 <- rbind(simcoe_2018_ind_W_as1, simcoe_2018_W_ts_k45)
simcoe_2018_ind_W_as1 <- rbind(simcoe_2018_ind_W_as1, simcoe_2018_W_ts_s15)

simcoe_2018_W_as1 <- simcoe_2018_ind_W_as1 %>% group_by(Year) %>%
  summarize(as2_2018 = sum(W_2018, na.rm = TRUE))

simcoe_mean_lc_sp_pairs_2018 <- rbind(simcoe_mean_W_sp_pairs_2018_c6, simcoe_mean_W_sp_pairs_2018_c9)
simcoe_mean_lc_sp_pairs_2018 <- rbind(simcoe_mean_lc_sp_pairs_2018, simcoe_mean_W_sp_pairs_2018_k42)
simcoe_mean_lc_sp_pairs_2018 <- rbind(simcoe_mean_lc_sp_pairs_2018, simcoe_mean_W_sp_pairs_2018_k45)
simcoe_mean_lc_sp_pairs_2018 <- rbind(simcoe_mean_lc_sp_pairs_2018, simcoe_mean_W_sp_pairs_2018_s15)
...
simcoe_mean_corr_2018_c6 <- simcoe_species_pairs_count_2018_c6 %>% ungroup() %>% select(corr, ind_pop_pair_cv_2018, ind_W_2018)
...
simcoe_mean_corr_2018_s15 <- simcoe_species_pairs_count_2018_s15 %>% ungroup() %>% select(corr, ind_pop_pair_cv_2018, ind_W_2018)
simcoe_mean_corr_2018_lc <- rbind(simcoe_mean_corr_2018_c6, simcoe_mean_corr_2018_c9)
simcoe_mean_corr_2018_lc <- rbind(simcoe_mean_corr_2018_lc, simcoe_mean_corr_2018_k42)
simcoe_mean_corr_2018_lc <- rbind(simcoe_mean_corr_2018_lc, simcoe_mean_corr_2018_k45)
simcoe_mean_corr_2018_lc <- rbind(simcoe_mean_corr_2018_lc, simcoe_mean_corr_2018_s15)
...
#subset dataframes by station to add a station tag to species id
simcoe_c6_2019 <- subset(simcoe_2019_m, Station_ID == 'C6')
simcoe_c6_2019$Species <- paste("C6", simcoe_c6_2019$Species, sep=" ")
...
simcoe_s15_2019 <- subset(simcoe_2019_m, Station_ID == 'S15')
simcoe_s15_2019$Species <- paste("S15", simcoe_s15_2019$Species, sep=" ")

#recombine dataframes
simcoe_spec_2019 <- rbind(simcoe_c6_2019, simcoe_c9_2019)
simcoe_spec_2019 <- rbind(simcoe_spec_2019, simcoe_k42_2019)
simcoe_spec_2019 <- rbind(simcoe_spec_2019, simcoe_k45_2019)
simcoe_spec_2019 <- rbind(simcoe_spec_2019, simcoe_s15_2019)
...
simcoe_c6_2019_w_cv_ts <- subset(simcoe_2019_cv, Station_ID == 'C6')
simcoe_c6_2019_w_cv_ts$Species <- paste("C6", simcoe_c6_2019_w_cv_ts$Species, sep=" ")
simcoe_c6_2019_w_cv_ts$Species_ID <- 1:nrow(simcoe_c6_2019_w_cv_ts)
...
simcoe_s15_2019_w_cv_ts <- subset(simcoe_2019_cv, Station_ID == 'S15')
simcoe_s15_2019_w_cv_ts$Species <- paste("S15", simcoe_s15_2019_w_cv_ts$Species, sep=" ")
simcoe_s15_2019_w_cv_ts$Species_ID <- 1:nrow(simcoe_s15_2019_w_cv_ts) 


simcoe_spec_2019_w_sp_ts <- rbind(simcoe_c6_2019_w_cv_ts, simcoe_c9_2019_w_cv_ts)
simcoe_spec_2019_w_sp_ts <- rbind(simcoe_spec_2019_w_sp_ts, simcoe_k42_2019_w_cv_ts)
simcoe_spec_2019_w_sp_ts <- rbind(simcoe_spec_2019_w_sp_ts, simcoe_k45_2019_w_cv_ts)
simcoe_spec_2019_w_sp_ts <- rbind(simcoe_spec_2019_w_sp_ts, simcoe_s15_2019_w_cv_ts)
...
#Step 1 
simcoe_2019_ind_W_ts_c6 <- filter(simcoe_2019_ind_W_ts, station_1 == "C6" & station_2 == "C6")
...
simcoe_2019_ind_W_ts_s15 <- filter(simcoe_2019_ind_W_ts, station_1 == "S15" & station_2 == "S15")


#Step 2 - Calculate Stabilization for each Station
#C6
simcoe_species_pairs_count_2019_c6 <- na.omit(simcoe_2019_ind_W_ts_c6)

simcoe_species_pairs_count_2019_c6$number_species_pairs <- nrow(simcoe_species_pairs_count_2019_c6)

simcoe_mean_W_sp_pairs_2019_c6 <- simcoe_species_pairs_count_2019_c6 %>% group_by(Year) %>%
  summarize(Station_ID = "C6",
            mean_lc_stab = mean(ind_W_2019, na.rm = T),
            total_species_pairs = mean(number_species_pairs))

simcoe_2019_W_ts_c6 <- simcoe_2019_ind_W_ts_c6 %>% group_by(Year) %>%
  summarize(W_2019 = sum(ind_W_2019, na.rm = TRUE))
...
#S15
simcoe_species_pairs_count_2019_s15 <- na.omit(simcoe_2019_ind_W_ts_s15)

simcoe_species_pairs_count_2019_s15$number_species_pairs <- nrow(simcoe_species_pairs_count_2019_s15)

simcoe_mean_W_sp_pairs_2019_s15 <- simcoe_species_pairs_count_2019_s15 %>% group_by(Year) %>%
  summarize(Station_ID = "S15",
            mean_lc_stab= mean(ind_W_2019, na.rm = T),
            total_species_pairs = mean(number_species_pairs))

simcoe_2019_W_ts_s15 <- simcoe_2019_ind_W_ts_s15 %>% group_by(Year) %>%
  summarize(W_2019 = sum(ind_W_2019, na.rm = TRUE))

#Step 4
simcoe_2019_ind_W_as1 <- rbind(simcoe_2019_W_ts_c6, simcoe_2019_W_ts_c9)
simcoe_2019_ind_W_as1 <- rbind(simcoe_2019_ind_W_as1, simcoe_2019_W_ts_k42)
simcoe_2019_ind_W_as1 <- rbind(simcoe_2019_ind_W_as1, simcoe_2019_W_ts_k45)
simcoe_2019_ind_W_as1 <- rbind(simcoe_2019_ind_W_as1, simcoe_2019_W_ts_s15)

simcoe_2019_W_as1 <- simcoe_2019_ind_W_as1 %>% group_by(Year) %>%
  summarize(as2_2019 = sum(W_2019, na.rm = TRUE))

simcoe_mean_lc_sp_pairs_2019 <- rbind(simcoe_mean_W_sp_pairs_2019_c6, simcoe_mean_W_sp_pairs_2019_c9)
simcoe_mean_lc_sp_pairs_2019 <- rbind(simcoe_mean_lc_sp_pairs_2019, simcoe_mean_W_sp_pairs_2019_k42)
simcoe_mean_lc_sp_pairs_2019 <- rbind(simcoe_mean_lc_sp_pairs_2019, simcoe_mean_W_sp_pairs_2019_k45)
simcoe_mean_lc_sp_pairs_2019 <- rbind(simcoe_mean_lc_sp_pairs_2019, simcoe_mean_W_sp_pairs_2019_s15)
...
simcoe_mean_corr_2019_c6 <- simcoe_species_pairs_count_2019_c6 %>% ungroup() %>% select(corr, ind_pop_pair_cv_2019, ind_W_2019)
...
simcoe_mean_corr_2019_s15 <- simcoe_species_pairs_count_2019_s15 %>% ungroup() %>% select(corr, ind_pop_pair_cv_2019, ind_W_2019)
simcoe_mean_corr_2019_lc <- rbind(simcoe_mean_corr_2019_c6, simcoe_mean_corr_2019_c9)
simcoe_mean_corr_2019_lc <- rbind(simcoe_mean_corr_2019_lc, simcoe_mean_corr_2019_k42)
simcoe_mean_corr_2019_lc <- rbind(simcoe_mean_corr_2019_lc, simcoe_mean_corr_2019_k45)
simcoe_mean_corr_2019_lc <- rbind(simcoe_mean_corr_2019_lc, simcoe_mean_corr_2019_s15)
...
write.csv(simcoe_final, "simcoe_final_weeks_5.csv")
...
write.csv(simcoe_corr, "simcoe_final_corr_weeks_5.csv")
...
write.csv(simcoe_pair_stab, "simcoe_final_pair_stab_weeks_5.csv")
